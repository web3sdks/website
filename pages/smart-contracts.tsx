...
const CONTRACTS_GUIDES = [
  {
    ...
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/12/subscribe_with_unlock-1.png",
    link: "https://blog.web3sdks.com/guides/build-a-subscription-with-unlock/",
  },
  {
    title: "Build An ERC721A NFT Collection using Solidity",
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/08/thumbnail-19.png",
  ...
  },
  {
    ...
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/09/This-is-the-one-4.png",
    link: "https://blog.web3sdks.com/guides/create-an-mayc-collection-clone/",
  },
];

const PreBuiltContracts: Web3sdksNextPage = () => {
  return (
    <ProductPage
      seo={{
