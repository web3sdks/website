...
const ExploreCategoryPage: Web3sdksNextPage = (
  ...
  return (
    <>
      <NextSeo
        ...
        description={`${props.category.description} Deploy with one click to Ethereum, Polygon, Optimism, and other EVM blockchains with web3sdks.`}
      />
