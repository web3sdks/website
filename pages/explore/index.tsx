...
const ExplorePage: Web3sdksNextPage = (
  ...
  return (
    <>
      <NextSeo
        ...
        openGraph={{
          title: "web3sdks Explore: Smart Contracts & Protocols",
          description:
            "Browse a large collection of ready-to-deploy contracts that have been built by web3sdks and other contract developers. Find a contract for your specific app's or game's needs.",
          images: [
            {
              url: "https://web3sdks.com/web3sdks-explore.png",
              width: 1200,
              height: 630,
