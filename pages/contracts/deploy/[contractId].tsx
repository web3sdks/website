...
import type { FeatureWithEnabled } from "@web3sdks/sdk/evm";
...
const ContractDeployDetailPage: Web3sdksNextPage = () => {
        ...
        <Flex gap={12} direction="column" as="main">
          ...
          <Center>
            <LinkButton
              ...
              href="https://docs.web3sdks.com/contractkit"
            >
              Learn about web3sdks extensions
            </LinkButton>
          </Center>
        </Flex>
      </Flex>
    ...
    >
      <Flex gap={2} align="center" justify="space-between">
        <Flex gap={2} align="center">
          ...
          <LinkOverlay
            href={`https://docs.web3sdks.com/contracts/${feature.docLinks.contracts}`}
            isExternal
            onClick={() =>
              trackEvent({
                category: "extensions-deploy",
