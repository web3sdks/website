...
const SHOPIFY_GUIDES = [
  {
    title: "How to Create a Token Gated Website on Shopify using web3sdks",
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/11/create-token-gated-website-with-shopify-storefront-and-web3sdks.png",
    link: "https://blog.web3sdks.com/guides/token-nft-gated-shopify-website-web3sdks/",
  },
  {
    title: "Generate Shopify Discount Codes For NFT Holders",
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/10/This-is-the-one--10-.png",
    link: "https://blog.web3sdks.com/guides/generate-shopify-discount-codes-for-nft-holders/",
  },
  {
    title: "Distribute NFTs on a Shopify Store",
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/10/This-is-the-one--11-.png",
    link: "https://blog.web3sdks.com/guides/shopify-selling-an-nft-as-a-digital-asset-on-shopify-store/",
  },
];

const Commerce: Web3sdksNextPage = () => {
  return (
    <ProductPage
      seo={{
        title: "Commerce | Solutions",
        description:
          "Create web3 e-commerce apps, build token-gated websites, and sell NFTs to your audience—all with web3sdks's Shopify integration. Start here.",
        openGraph: {
          images: [
            {
              url: "https://web3sdks.com/web3sdksxshopify.png",
              width: 1200,
              height: 630,
              alt: "web3sdks x shopify",
            },
          ],
        },
      }}
    >
      <Hero
        ...
        description="With web3sdks you can now add powerful web3 features to your Shopify storefront enabling tokengated commerce, NFT loyalty programs, digital collectible sales, and more."
        buttonText="Get started"
        buttonLink="https://blog.web3sdks.com/tag/shopify/"
      ...
      <ProductSection>
        ...
        >
          ...
          <ProductLearnMoreCard
            ...
            href="https://docs.web3sdks.com/sdk"
          />
          <ProductLearnMoreCard
            title="Manage"
