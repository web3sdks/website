...
const GAMING_GUIDES = [
  {
    ...
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/11/Group-625859--1-.png",
  ...
  },
  {
    ...
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/12/This-is-the-one--33-.png",
  ...
  },
  {
    ...
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/12/Coinbase-Pay-guide.png",
...
const GAMING_CASE_STUDIES = [
  {
    ...
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/12/Chicago-Bulls.png",
    link: "https://blog.web3sdks.com/evolved-camels-builds-immersive-web3-gaming-experiences-for-their-community/",
  },
  {
    title: "Fractal, Web3 Gaming Platform and Marketplace for Blockchain Games",
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/11/Fractal.png",
    link: "https://blog.web3sdks.com/fractal-web3-gaming-platform-and-marketplace-for-blockchain-games-expands-to-evm-chains/",
  },
  {
    title:
      "Dreamworks Launches NFT Avatars for the Metaverse in Collaboration with Gala's VOX",
    image:
      "https://blog.web3sdks.com/content/images/size/w2000/2022/10/DreamWorks-Launches-NFT-Avatars-with-Gala-s-VOX---web3sdks-Case-Study-2.png",
    link: "https://blog.web3sdks.com/dreamworks-launches-nft-avatars-for-web3-games-with-gala-and-the-sims-creators-voxverse/",
  },
];

const Gaming: Web3sdksNextPage = () => {
  return (
    <ProductPage
      accentColor="rgba(22,82,240,.75)"
      seo={{
        title:
          "web3sdks GamingKit | SDKs, Smart Contracts & Dev Tools for Web3 Games",
        description:
        ...
        openGraph: {
          images: [
            {
              url: `${getAbsoluteUrl()}/web3sdksxcoinbase.png`,
              width: 1200,
              height: 630,
              alt: "web3sdks x coinbase",
            },
          ],
        },
      }}
    >
      <Hero
        ...
        buttonLink="https://docs.web3sdks.com/gamingkit"
        ...
        secondaryButton={{
          text: "Request demo",
          link: "https://web3sdks.typeform.com/tw-solutions",
        }}
      >
        <SimpleGrid
      ...
      <ProductSection py={{ base: 12, lg: 24 }}>
        <SDKSection
          ...
          codeSelectorProps={{
            ...
            docs: "https://docs.web3sdks.com/gamingkit",
          }}
        />
      </ProductSection>
      ...
      <ProductSection>
        ...
        >
          ...
          <ProductLearnMoreCard
            ...
            href="https://docs.web3sdks.com/gamingkit"
          />
          <ProductLearnMoreCard
            title="Manage"
            ...
            href="https://docs.web3sdks.com/dashboard"
          />
        </SimpleGrid>
      </ProductSection>
      ...
      <GuidesShowcase
        ...
        description="Check out our guides and case studies to start building games with web3sdks"
        solution="Gaming"
