...
const GasPage: Web3sdksNextPage = () => {
  ...
  return (
    <>
      <NextSeo
        ...
        description="Estimate the cost of gas fees when deploying contracts or performing common use cases to the blockchain on web3sdks."
        openGraph={{
          title: "Blockchain Gas Estimator | web3sdks",
          url: `https://web3sdks.com/gas`,
        }}
      />
      <Flex mb={4}>
        <Heading mr={3} as="h1">
      ...
      <Text mt={4} textAlign="center">
        ...
        deployed with web3sdks. Updated every 60 seconds.
      </Text>
    </>
  );
};
