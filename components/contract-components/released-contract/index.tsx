...
export const ReleasedContract: React.FC<ReleasedContractProps> = ({
  ...
  const twitterIntentUrl = useMemo(() => {
    ...
    url.searchParams.append(
      "text",
      `Check out this ${releaseName} contract on @web3sdks
  ...
  return (
    <>
      <NextSeo
        ...
        description={`${release.description}${
          release.description ? ". " : ""
        }Deploy ${releaseName} in one click with web3sdks.`}
        openGraph={{
          title,
          url: currentRoute,
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: `${releaseName} contract on web3sdks`,
            },
          ],
        }}
      />
                ...
                enabledExtensions.map((extension) => (
                  <ListItem key={extension.name}>
                    <Flex gap={2} alignItems="center">
                      ...
                      <Text size="label.md">
                        <TrackedLink
                          href={`https://docs.web3sdks.com/contracts/${extension.docLinks.contracts}`}
                          isExternal
                          category="extension"
            ...
            <Flex gap={2} alignItems="center">
              <ShareButton
                ...
                text={`Deploy ${shortenIfAddress(
                  releaserEnsOrAddress,
                )}/${releaseName} in one click with web3sdks.`}
              />
              <TrackedIconButton
                as={LinkButton}
                isExternal
