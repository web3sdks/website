...
import twAudited from "public/brand/web3sdks-audited-2.png";
      ...
      >
        ...
        >
          ...
          <Flex gap={2}>
            <LinkButton
              variant="outline"
              isExternal
              href={`https://docs.web3sdks.com/pre-built-contracts/${contractType}`}
              onClick={() =>
                trackEvent({
        ...
        <Flex direction="column">
          ...
          <Text size="body.md" fontStyle="italic">
            ...
            with a testnet.{" "}
            <TrackedLink
              href="https://blog.web3sdks.com/guides/which-network-should-you-use"
              color="primary.600"
              category="deploy"
