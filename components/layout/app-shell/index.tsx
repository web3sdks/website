    ...
    >
      {!noSEOOverride && (
        <NextSeo
          title="Dashboard"
          openGraph={{
            title: "Dashboard | web3sdks",
            url: `https://web3sdks.com/dashboard`,
          }}
        />
      )}
      <Flex
          ...
          >
            ...
            <Flex align="center" gap={2} marginLeft="auto">
              ...
              <Button
                as={TrackedLink}
                variant="link"
                href="https://support.web3sdks.com"
                isExternal
                category="header"
                label="support"
                flexDir="row"
            ...
            <Flex direction="column" gap={4}>
              ...
              >
                <Text alignSelf="center" order={{ base: 2, md: 0 }}>
                  web3sdks &copy; {new Date().getFullYear()}
                </Text>
                <Flex align="center" justify="center" gap={4}>
                  <TrackedLink
                    isExternal
                    href="https://feedback.web3sdks.com"
                    category="footer"
                    label="feedback"
                  >
                    Feedback
