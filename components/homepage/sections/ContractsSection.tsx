          ...
          >
            ...
            >
              ...
              <ContractsDescriptorItem
                title="Explore"
                description="Browse a large collection of ready-to-deploy contracts that have been built by web3sdks and other contract developers. Find a contract for your specific app's or game's needs."
            ...
            >
              ...
              <ContractsDescriptorItem
                ...
                description={
                  <>
                    ...
                    <TrackedLink
                      href="https://docs.web3sdks.com/contracts-sdk/base-contracts/erc-20/erc20base"
                    ...
                    ,{" "}
                    <TrackedLink
                      href="https://docs.web3sdks.com/contracts-sdk/base-contracts/erc-721/erc721base"
                      category="landing-contracts"
                      label="base-erc721"
                      borderBottom="1px solid"
                      isExternal
                    ...
                    and{" "}
                    <TrackedLink
                      href="https://docs.web3sdks.com/contracts-sdk/base-contracts/erc-1155/erc1155base"
                      category="landing-contracts"
                      label="base-erc1155"
                      borderBottom="1px solid"
                      isExternal
              ...
              <ContractsDescriptorItem
                ...
                description={
                  <>
                    ...
                    ,{" "}
                    <TrackedLink
                      href="https://docs.web3sdks.com/contractkit/extension-contracts/royalty"
                      category="landing-contracts"
                    ...
                    ,{" "}
                    <TrackedLink
                      href="https://docs.web3sdks.com/contractkit/interfaces/erc721revealable"
                      category="landing-contracts"
              ...
              <Flex h="full" alignItems="end">
                <LinkButton
                  href="https://docs.web3sdks.com/contractkit"
                  variant="solid"
                  colorScheme="whiteAlpha"
                  bg="white"
                  color="black"
