...
const INSTALL_COMMANDS = {
  evm: {
    typescript: "npm install @web3sdks/sdk ethers",
    javascript: "npm install @web3sdks/sdk ethers",
    react: "npm install @web3sdks/sdk @web3sdks/react ethers",
    python: "pip install web3sdks-sdk",
    go: "go get github.com/web3sdks/go-sdk/web3sdks",
  },
  solana: {
    typescript: "npm install @web3sdks/sdk",
    javascript: "npm install @web3sdks/sdk",
    react:
...
const CREATE_APP_COMMANDS = {
  evm: "npx web3sdks@latest create app --evm",
  solana: "npx web3sdks@latest create app --solana",
};
...
function useContractCodeSnippetQuery(ecosystem: "evm" | "solana") {
  return useQuery(["code-snippet"], async () => {
    ...
    const res = await fetch(
      `https://raw.githubusercontent.com/web3sdks/docs/main/docs/${filename}.json`,
    );
