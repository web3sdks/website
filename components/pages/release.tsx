...
import { PREBUILT_CONTRACTS_MAP } from "@web3sdks/sdk/evm";
...
import { WEB3SDKS_DEPLOYER_ADDRESS } from "constants/addresses";
...
export const ReleaseWithVersionPage: React.FC<ReleaseWithVersionPageProps> = ({
  ...
  const prebuiltContractName =
    release?.releaser === WEB3SDKS_DEPLOYER_ADDRESS
