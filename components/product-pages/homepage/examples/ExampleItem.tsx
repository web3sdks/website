...
const EXAMPLES_MAP = {
  nftDrops: {
    title: "NFT drops",
    href: "https://github.com/web3sdks-template/nft-drop",
    svg: NFTDrops,
  },
  marketplaces: {
    title: "NFT marketplaces",
    href: "https://github.com/web3sdks-template/marketplace-next-ts",
    svg: Marketplaces,
  },
  tokenGated: {
    title: "Token Gating",
  ...
  daos: {
    title: "DAOs",
    href: "https://github.com/web3sdks-template/dao",
    svg: DAOs,
  },
  creatorTools: {
    title: "Creator tools",
    href: "https://github.com/web3sdks-template/creator-platform",
    svg: CreatorTools,
  },
  communityRewards: {
    title: "Community rewards",
    href: "https://github.com/web3sdks-template/community-rewards",
    svg: CommunityRewards,
  },
  playToEarnGames: {
    title: "Play-to-earn games",
    href: "https://github.com/web3sdks-template/play-to-earn-game/",
    svg: PlayToEarnGames,
  },
  defiProtocols: {
