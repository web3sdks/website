...
const COMMANDS = {
  install: {
    ...
    web3button: "npm install @web3sdks/react @web3sdks/sdk ethers",
    python: "pip install web3sdks-sdk",
    go: "go get github.com/web3sdks/go-sdk/web3sdks",
  },
  setup: {
...
const contract = await sdk.getContract("{{contract_address}}");`,
    react: `import { useContract } from "@web3sdks/react";
...
export default function Component() {
  ...
  // Now you can use the contract in the rest of the component
    ...
    web3button: `import { Web3Button } from "@web3sdks/react";
...
export default function Component() {
  ...
  write: {
    javascript: `const data = await contract.call("{{function}}", {{args}})`,
    react: `import { useContract, useContractWrite } from "@web3sdks/react";
