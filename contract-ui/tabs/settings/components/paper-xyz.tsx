...
import type { EditionDrop, NFTDrop } from "@web3sdks/sdk/evm";
import {
  formatError,
  formatResponseData,
...
function createCodeSnippet(
  ...
  if (language === "javascript") {
    code = `
import { Web3sdksSDK } from "@web3sdks/sdk/evm";

async function createCheckoutIntent() {
  const sdk = new Web3sdksSDK("${network}");
