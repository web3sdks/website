...
const settingTypeMap = {
  metadata: {
    ...
    portalLink:
      "https://docs.web3sdks.com/contractkit/extension-contracts/contractmetadata",
  },
  primarySale: {
    name: "Primary Sales",
    portalLink:
      "https://docs.web3sdks.com/contractkit/extension-contracts/primarysale",
  },
  royalties: {
    name: "Royalties",
    portalLink:
      "https://docs.web3sdks.com/contractkit/extension-contracts/royalty",
  },
  platformFee: {
    name: "Platform Fee",
    portalLink:
      "https://docs.web3sdks.com/contractkit/extension-contracts/platformfee",
  },
} as const;
