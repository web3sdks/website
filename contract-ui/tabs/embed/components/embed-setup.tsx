...
import { DropContract } from "@web3sdks/react";
...
const IPFS_URI = "ipfs://Qmcine1gpZUbQ73nk7ZGCcjKBVFYXrEtqrhujXk3HDQ6Nn";
...
export const EmbedSetup: React.FC<EmbedSetupProps> = ({
  ...
  const { register, watch } = useForm<{
    ...
    defaultValues: {
      ipfsGateway: "https://ipfscdn.web3sdks.com/ipfs/",
      tokenId: "0",
      listingId: "0",
      theme: "light",
      primaryColor: "purple",
            ...
            <FormControl gap={4}>
              ...
              <FormHelperText>
                ...
                <Link
                  isExternal
                  color="blue.500"
                  href="https://blog.web3sdks.com/guides/setup-gasless-transactions"
                >
                  Learn more
                </Link>
              </FormHelperText>
